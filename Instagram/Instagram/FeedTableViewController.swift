...
//  Instagram
//
//  Created by Amin Rezapour on 8/9/16.
...
class FeedTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        query?.findObjectsInBackgroundWithBlock({ (objects, error) -> Void in
            ...
            getFollowedUserQuery.whereKey("following", equalTo: PFUser.currentUser()!.objectId!)
            getFollowedUserQuery.findObjectsInBackgroundWithBlock { (objects, error) -> Void in
                ...
                if let objects = objects {
                    ...
                    for object in objects {
                        ...
                        var followedUser = object["follower"] as! String
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.postedImage.image = UIImage(named: "default.png")
